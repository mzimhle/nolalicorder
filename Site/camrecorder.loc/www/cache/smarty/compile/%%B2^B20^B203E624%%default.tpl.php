<?php /* Smarty version 2.6.20, created on 2019-08-05 15:13:55
         compiled from product/default.tpl */ ?>
<!DOCTYPE html>
        ...
        <div class="col-md-12">		
          <div class="portlet">
			...
			<div class="portlet-content">
				<button class="btn btn-secondary fr" type="button" onclick="link('/product/details.php'); return false;">Add a new product</button><br/ ><br />
				<div class="row">
...
function getRecords() {
	...
	$(\'#tableContent\').html(\'\');
	$(\'#tableContent\').html(\'<table cellpadding="0" cellspacing="0" width="100%" border="0" class="display" id="dataTable"><thead><tr><th>Cipher</th><th>Name</th><th>Description</th><th></th></tr></thead><tbody id="productbody"><tr><td colspan="4" align="center"></td></tr></tbody></table>\');	
