<?php /* Smarty version 2.6.20, created on 2019-08-07 13:06:08
         compiled from configuration/course/details.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'configuration/course/details.tpl', 61, false),)), $this); ?>
<!DOCTYPE html>
				...
				<div class="row">	
					<div class="col-sm-3">	
						<div class="form-group">
							<label for="course_cipher" class="error">Code</label>
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<select id="department_code" name="department_code" class="form-control">
								<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['departmentpairs'],'selected' => $this->_tpl_vars['courseData']['department_code']), $this);?>
