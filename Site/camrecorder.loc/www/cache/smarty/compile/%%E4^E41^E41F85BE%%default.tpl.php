<?php /* Smarty version 2.6.20, created on 2019-08-07 16:52:25
         compiled from participant/default.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'participant/default.tpl', 110, false),)), $this); ?>
<!DOCTYPE html>
				...
				<div class="row">
					<div class="col-sm-12">				
						<div class="form-group">
							...
							<select id="class_list[]" name="class_list[]" class="form-control classList" multiple readonly></select>		  
...
$(document).ready(function() {
	...
	$( "#class_name" ).autocomplete({
		...
		select: function( event, ui ) {
			if(ui.item.id != \'\') {
				addOption(ui.item.id, ui.item.value);
			}
			$(\'#class_name\').html(\'\');
			$(\'#class_code\').val(\'\');									
		}
...
function addOption(code, name) {
	var html = \'\';
	$(".classList option").each(function(i){
