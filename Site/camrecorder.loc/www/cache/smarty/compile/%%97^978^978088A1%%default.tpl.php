<?php /* Smarty version 2.6.20, created on 2019-08-07 11:39:56
         compiled from configuration/campus/default.tpl */ ?>
<!DOCTYPE html>
          ...
          <div class="portlet">
			...
			<div class="portlet-content">		
				<div class="form-group">
				  <label for="filter_search">Search for campus name</label>
				...
				<div class="form-group">
					...
					<button class="btn btn-secondary fr" type="button" onclick="link('/configuration/campus/details.php'); return false;">Add a new campus</button>
				</div>
...
function getRecords() {
	...
	$(\'#tableContent\').html(\'<table cellpadding="0" cellspacing="0" width="100%" border="0" class="display" id="dataTable"><thead><tr><th>Code</th><th>Full name</th><th>Physical Address</th><th></th></tr></thead><tbody id="campusbody"><tr><td colspan="2" align="center"><img src="/images/ajax_loader.gif" /></td></tr></tbody></table>\');	
		...
		"fnServerData": function ( sSource, aoData, fnCallback ) {
			$.getJSON( sSource, aoData, function (json) {
				if (json.result === false) {
					$(\'#campusbody\').html(\'<tr><td colspan="2" align="center">No results</td></tr>\');
				} else {
...
function csv() {
	var filter_search		= $(\'#filter_search\').val() != \'undefined\' ? $(\'#filter_search\').val() : \'\';
	window.location.href	= "/configuration/campus/?action=search&filter_csv=1&filter_search="+filter_search;
	return false;
}
</script>
'; ?>
