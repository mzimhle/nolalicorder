(function(t) {
    var e = typeof self == "object" && self.self === self && self || typeof global == "object" && global.global ===
        global && global;
    ...
    i.extend(x.prototype, u, {
        ...
        get: function(t) {
            ...
            return this._byId[t] || this._byId[this.modelId(t.attributes || t)] || t.cid && this._byId[
                t.cid]
        },
        has: function(t) {
            return this.get(t) != null
    ...
    i.extend(N.prototype, u, {
        ...
        getPath: function() {
            var t = this.decodeFragment(this.location.pathname + this.getSearch()).slice(this.root.length -
                1);
        ...
        start: function(t) {
            ...
            this._hasHashChange = "onhashchange" in window && (document.documentMode === void 0 ||
...
//# sourceMappingURL=/js/lib/backbone-1.3.3.min.map
