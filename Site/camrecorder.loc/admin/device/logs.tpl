...
<div class="container">
  <div class="content">
	...
	<div class="content-header">
		...
		<li><a href="/device/details.php?code={$deviceData.device_code}">{$deviceData.device_name}</a></li>		
...
function getRecords() {
	...
	oTable = $('#dataTable').dataTable({
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "/device/logs.php?code={/literal}{$deviceData.device_code}{literal}&action=search&filter_csv=0&filter_search="+filter_search,
