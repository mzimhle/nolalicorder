...
<div class="container">
  <div class="content">
	...
	<ol class="breadcrumb">
		...
		<li>{if isset($participantData)}<a href="/teacher/details.php?code={$participantData.participant_code}">{$participantData.participant_name} {$participantData.participant_surname}</a>{else}Add a participant{/if}</li>
      ...
      <div class="row">
        <div class="col-sm-9">
          <div class="portlet">
            ...
            <div class="portlet-content">
              <form id="detailsForm" action="/teacher/details.php{if isset($participantData)}?code={$participantData.participant_code}{/if}" method="POST" data-validate="parsley" class="form parsley-form" enctype="multipart/form-data"> 
		...
		<div class="col-sm-3">
			<div class="list-group">  
				<a href="/teacher/" class="list-group-item">
				  <i class="fa fa-asterisk"></i> &nbsp;&nbsp;List
				  <i class="fa fa-chevron-right list-group-chevron"></i>
				</a>
				{if isset($participantData)}
				<a href="/teacher/details.php?code={$participantData.participant_code}" class="list-group-item">
