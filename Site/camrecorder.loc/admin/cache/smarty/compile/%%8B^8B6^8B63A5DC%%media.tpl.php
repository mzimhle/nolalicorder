<?php /* Smarty version 2.6.20, created on 2019-08-05 17:03:11
         compiled from account/media.tpl */ ?>
<!DOCTYPE html>
...
<div class="container">
  <div class="content">
	...
	<div class="content-header">
		...
		<li><a href="/account/details.php?code=<?php echo $this->_tpl_vars['accountData']['account_code']; ?>
        ...
        <div class="col-sm-9">
          <div class="portlet">
            ...
            <div class="portlet-content">
              <form id="validate-basic" action="/account/media.php?code=<?php echo $this->_tpl_vars['accountData']['account_code']; ?>
...
<?php echo $this->_tpl_vars['account']['media_path']; ?>
/big_<?php echo $this->_tpl_vars['account']['media_code']; ?>
<?php echo $this->_tpl_vars['account']['media_ext']; ?>
" target="_blank">
									<img src="<?php echo $this->_tpl_vars['config']['site']; ?>
<?php echo $this->_tpl_vars['account']['media_path']; ?>
/tny_<?php echo $this->_tpl_vars['account']['media_code']; ?>
<?php echo $this->_tpl_vars['account']['media_ext']; ?>
" width="60" />
								</a>
							</td>
							<td><?php echo $this->_tpl_vars['account']['media_category']; ?>
</td>								
							<td>
								<?php if ($this->_tpl_vars['account']['media_primary'] == '0'): ?>
									<button value="Make Primary" class="btn btn-danger" onclick="statusSubModal('<?php echo $this->_tpl_vars['account']['media_code']; ?>
', '1', 'media', '<?php echo $this->_tpl_vars['accountData']['account_code']; ?>
'); return false;">Primary</button>
							...
							<td>
								<?php if ($this->_tpl_vars['account']['media_primary'] == '0'): ?>
									<button value="Delete" class="btn btn-danger" onclick="deleteModal('<?php echo $this->_tpl_vars['account']['media_code']; ?>
', '<?php echo $this->_tpl_vars['accountData']['account_code']; ?>
