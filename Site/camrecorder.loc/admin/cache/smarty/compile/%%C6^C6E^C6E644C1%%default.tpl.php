<?php /* Smarty version 2.6.20, created on 2018-08-02 09:02:18
        ...
        <div class="col-md-12">		
          <div class="portlet">
			...
			<div class="portlet-content">
				<button class="btn btn-secondary fr" type="button" onclick="link('/campaign/details.php'); return false;">Add a new campaign</button><br/ ><br />
				<div class="row">
...
function getRecords() {
	...
	$(\'#tableContent\').html(\'\');
	$(\'#tableContent\').html(\'<table cellpadding="0" cellspacing="0" width="100%" border="0" class="display" id="dataTable"><thead><tr><th>Name</th><th>SMS Messages</th><th>SMS Sent Out</th><th>Email Messages</th><th>Emails Sent out</th></tr></thead><tbody id="campaignbody"><tr><td colspan="5" align="center"></td></tr></tbody></table>\');	
...
<!-- Modal -->
<div class="modal fade" id="sendCampaignModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button class="btn btn-warning" type="button" onclick="javascript:sendCampaign();">I'm sure, send it</button>
