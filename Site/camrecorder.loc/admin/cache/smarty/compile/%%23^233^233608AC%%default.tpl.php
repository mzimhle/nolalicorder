<?php /* Smarty version 2.6.20, created on 2018-07-24 20:06:20
         compiled from subscription/default.tpl */ ?>
<!DOCTYPE html>
        ...
        <div class="col-md-12">		
          <div class="portlet">
			...
			<div class="portlet-content">
				<button class="btn btn-secondary fr" type="button" onclick="link('/subscription/details.php'); return false;">Add a new subscription</button><br/ ><br />
				<div class="row">
...
function getRecords() {
	...
	$(\'#tableContent\').html(\'\');
	$(\'#tableContent\').html(\'<table cellpadding="0" cellspacing="0" width="100%" border="0" class="display" id="dataTable"><thead><tr><th>Name</th><th></th><th></th></tr></thead><tbody id="subscriptionbody"><tr><td colspan="2" align="center"></td></tr></tbody></table>\');	
		...
		"fnServerData": function ( sSource, aoData, fnCallback ) {
			$.getJSON( sSource, aoData, function (json) {
				if (json.result === false) {
					$(\'#subscriptionbody\').html(\'<tr><td colspan="3" align="center">No results</td></tr>\');
				} else {
...
function makePrimaryModal(id) {
	$(\'#subscription_status\').val(id);
	$(\'#makePrimaryModal\').modal(\'show\');
	return false;
}
function makePrimary() {
	
	var id	= $(\'#subscription_status\').val();
	
	$.ajax({
		type: "GET",
		url: "default.php",
		data: "primary_code="+id,
		dataType: "json",
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Primary Subscription</h4>
			</div>
			<div class="modal-body">Are you sure that you want to make this subscription the primary one?</div>
			<div class="modal-footer">
				<button data-dismiss="modal" class="btn btn-default" type="button">Cancel</button>
				<button class="btn btn-warning" type="button" onclick="javascript:makePrimary();">Yes</button>
				<input type="hidden" id="subscription_status" name="subscription_status" value=""/>
			</div>
		</div>
	</div>
</div>
