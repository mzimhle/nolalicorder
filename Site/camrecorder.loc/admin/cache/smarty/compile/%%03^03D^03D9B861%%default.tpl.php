<?php /* Smarty version 2.6.20, created on 2019-09-07 18:17:32
         compiled from configuration/department/default.tpl */ ?>
<!DOCTYPE html>
          ...
          <div class="portlet">
			...
			<div class="portlet-content">		
				...
				<div class="form-group">
					...
					<button class="btn btn-secondary fr" type="button" onclick="link('/configuration/department/details.php'); return false;">Add a new department</button>
				</div>
...
function getRecords() {
	...
	$(\'#tableContent\').html(\'<table cellpadding="0" cellspacing="0" width="100%" border="0" class="display" id="dataTable"><thead><tr><th>Faculty</th><th>Name</th><th></th></tr></thead><tbody id="departmentbody"><tr><td colspan="3" align="center"><img src="/images/ajax_loader.gif" /></td></tr></tbody></table>\');	
