<?php /* Smarty version 2.6.20, created on 2019-09-07 21:12:52
         compiled from schedule/default.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'schedule/default.tpl', 101, false),)), $this); ?>
<!DOCTYPE html>
...
function getRecords() {
	...
	oTable = $(\'#dataTable\').dataTable({
		...
		"bProcessing": true,
		"bServerSide": true,		
		"sAjaxSource": "?action=search&filter_csv=0&filter_search="+filter_search+"&filter_room="+filter_room+"&filter_date="+filter_date,
