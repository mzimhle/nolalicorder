<?php /* Smarty version 2.6.20, created on 2019-09-07 18:17:29
         compiled from configuration/faculty/default.tpl */ ?>
<!DOCTYPE html>
          ...
          <div class="portlet">
			...
			<div class="portlet-content">		
				<div class="form-group">
				  <label for="filter_search">Search for faculty name</label>
				...
				<div class="form-group">
					...
					<button class="btn btn-secondary fr" type="button" onclick="link('/configuration/faculty/details.php'); return false;">Add a new faculty</button>
				</div>
...
function getRecords() {
	...
	$(\'#tableContent\').html(\'<table cellpadding="0" cellspacing="0" width="100%" border="0" class="display" id="dataTable"><thead><tr><th>Full name</th><th></th></tr></thead><tbody id="facultybody"><tr><td colspan="2" align="center"><img src="/images/ajax_loader.gif" /></td></tr></tbody></table>\');	
		...
		"fnServerData": function ( sSource, aoData, fnCallback ) {
			$.getJSON( sSource, aoData, function (json) {
				if (json.result === false) {
					$(\'#facultybody\').html(\'<tr><td colspan="2" align="center">No results</td></tr>\');
				} else {
...
function csv() {
	var filter_search		= $(\'#filter_search\').val() != \'undefined\' ? $(\'#filter_search\').val() : \'\';
	window.location.href	= "/configuration/faculty/?action=search&filter_csv=1&filter_search="+filter_search;
	return false;
}
</script>
'; ?>
