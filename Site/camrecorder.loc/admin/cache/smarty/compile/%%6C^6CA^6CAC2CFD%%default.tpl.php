<?php /* Smarty version 2.6.20, created on 2019-09-08 12:05:32
         compiled from device/default.tpl */ ?>
<!DOCTYPE html>
          ...
          <div class="portlet">
			...
			<div class="portlet-content">		
				...
				<div class="form-group">
					...
					<button class="btn btn-secondary" type="button" onclick="link('/device/details.php'); return false;">Add a new device</button>
				</div>
...
function getRecords() {
	...
	$(\'#tableContent\').html(\'\');
	$(\'#tableContent\').html(\'<table cellpadding="0" cellspacing="0" width="100%" border="0" class="display" id="dataTable"><thead><tr><th>Code</th><th>Device Name</th><th>Campus</th><th>Room</th><th>Status</th><th>Last Seen</th><th></th></tr></thead><tbody id="devicebody"><tr><td colspan="6" align="center"><img src="/images/ajax_loader.gif" /></td></tr></tbody></table>\');	
		...
		"fnServerData": function ( sSource, aoData, fnCallback ) {
			$.getJSON( sSource, aoData, function (json) {
				if (json.result === false) {
					$(\'#devicebody\').html(\'<tr><td colspan="6" align="center">No results</td></tr>\');
				} else {
...
function csv() {
	var filter_search		= $(\'#filter_search\').val() != \'undefined\' ? $(\'#filter_search\').val() : \'\';
	window.location.href	= "/configuration/device/?action=search&filter_csv=1&filter_search="+filter_search;
	return false;
}
